...
export default function HalaxyWidget() {
  ...
  return (
    <div className="relative w-full rounded-3xl overflow-hidden shadow-warm border border-brand-sand bg-brand-cream min-h-[calc(100dvh-4rem)]">
      {!loaded && (
      ...
      <iframe
        ...
        allow="payment"
        className={`w-full min-h-[calc(100dvh-4rem)] border-0 transition-opacity duration-300 ${loaded ? 'opacity-100' : 'opacity-0'}`}
